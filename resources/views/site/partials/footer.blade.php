    ...
    <div class="container">
        <div class="footer-top">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6 text-center text-md-start">
                    <h5 class="color-white wow fadeInDown">Đăng ký ngay để nhận giá ưu đãi bí mật – giá sẽ giảm ngay khi bạn vừa đăng ký!</h5>
                </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-12 footer-1">
                <div class="mt-20 mb-20">
                    ...
                    <div class="box-info-contact mt-0">
                        <p class="text-md neutral-400 icon-address">{{ $config->address_company }}</p>
                        <p class="text-md neutral-400 icon-worktime">Giờ làm việc: 8:00 - 17:00, T2 - T7</p>
                        <p class="text-md neutral-400 icon-email">{{ $config->email }}</p>
                    </div>
                    <div class="box-need-help">
                        <p class="need-help text-md-medium mb-5">Hotline 24/7</p>
                        <br /><a class="heading-6 phone-support" href="tel:{{ $config->hotline }}">{{ $config->hotline }}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-2 col-xs-6 footer-3">
                <h6 class="text-linear-3">Công ty</h6>
            ...
            <div class="col-md-2 col-xs-6 footer-4">
                <h6 class="text-linear-3">Sản phẩm</h6>
                <ul class="menu-footer">
            ...
            <div class="col-md-2 col-xs-6 footer-2">
                <h6 class="text-linear-3">Dịch vụ</h6>
                <ul class="menu-footer">
            ...
            <div class="col-md-3 col-xs-6 footer-5">
                <h6 class="text-linear-3">Hỗ trợ</h6>
                <ul class="menu-footer">
        ...
        <div class="footer-bottom mt-50">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-md-start text-center mb-20">
                    <p class="text-sm color-white">© 2025 Lê Sơn</p>
                </div>
